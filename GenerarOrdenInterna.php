...
$connectionInfo = array("Database"=>"Proyecto_Integrador1", "UID"=>"sa", "PWD"=>"12345678", "CharacterSet" => "UTF-8");
...
WHERE 
    OI.No_orden_interna = 1;
"; // Aquí va la consulta SQL que proporcioné anteriormente
